...
def talker():
	...
	while not rospy.is_shutdown():
		...
		img = cv2.imread("/home/ubuntu/current.jpg")
		resized_img = cv2.resize(img, (1280, 960)) #use this if you want to use a different sized image
                #resized_img = cv2.resize(img, (160, 120))
